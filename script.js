...
(() => {
  ...
  var le = (e, t, r) => (
    ...
    Ye = (e) => ua(Cr({}, "__esModule", { value: !0 }), e);
  var Hn = f(() => {
    "use strict";
    window.tram = (function (e) {
      ...
      var g = (function (c, _, S) {
          ...
          function Z(ie, he) {
            function V() {
              var Se = new ae();
              return T(Se.init) && Se.init.apply(Se, arguments), Se;
            }
            function ae() {}
            he === S && ((he = ie), (ie = Object)), (V.Bare = ae);
            var se,
              _e = (L[c] = ie[c]),
              je = (ae[c] = V[c] = new L());
            return (
              ...
              (V.open = function (Se) {
                if (
                  ...
                  for (var er in se) _.call(se, er) && (je[er] = se[er]);
                return T(je.init) || (je.init = ie), V;
              }),
              V.open(he)
            );
          }
        ...
        h = {
          ease: [
            ...
            function (c, _, S, x) {
              ...
              return (
                _ +
                S * (-2.75 * L * T + 11 * T * T + -15.5 * L + 8 * T + 0.25 * c)
              );
            },
          ],
          "ease-in": [
          ...
          "ease-out": [
            ...
            function (c, _, S, x) {
              ...
              return (
                _ +
                S * (0.3 * L * T + -1.6 * T * T + 2.2 * L + -1.8 * T + 1.9 * c)
              );
            },
          ],
          "ease-in-out": [
        ...
        F = ["-webkit-", "-moz-", "-o-", "-ms-"],
        B = function (c) {
          if (c in k.style) return { dom: c, css: c };
          var _,
            S,
            x = "",
            T = c.split("-");
      ...
      if (U.transition) {
        var ee = U.timing.dom;
        if (((k.style[ee] = h["ease-in-back"][0]), !k.style[ee]))
      ...
      var q = (t.frame = (function () {
        ...
        d = g(function (c) {
            ...
            if (te) {
              ...
              if (de == "object") {
                ...
                je.call(
                  ...
                  te,
                  function (Ie, kv) {
                    Ie.span > Oe && (Oe = Ie.span), Ie.stop(), Ie.animate(kv);
                  },
                  function (Ie) {
          ...
          function ie(te) {
            Z.call(this, te), je.call(this, te, er, Fv);
          }
          function he(te) {
              ...
              (Ve = te[de]),
                de in fe
                  ? (Ie.transform || (Ie.transform = {}),
                    (Ie.transform[de] = Ve))
                  : (P.test(de) && (de = r(de)),
                    de in G ? (Ie[de] = Ve) : (Le || (Le = {}), (Le[de] = Ve)));
            for (de in Ie) {
              if (((Ve = Ie[de]), (Oe = this.props[de]), !Oe)) {
                if (!Rr) continue;
                Oe = _.call(this, de);
              }
              ce.call(this, Oe, Ve);
          ...
          (c.init = function (te) {
            ...
            U.backface &&
              oe.hideBackface &&
              p(this.el, U.backface.css, "hidden");
          }),
            Ge("add", _),
            Ge("start", S),
            Ge("wait", x),
        ...
        y = g(d, function (c) {
          function _(S, x) {
            ...
            return T.el || T.init(S), x ? T.start(x) : T;
          }
          c.init = function (S, x) {
            var T = e(S);
        ...
        I = g(function (c) {
          ...
          function S(L, Z, ie) {
            return Z !== void 0 && (ie = Z), L in h ? L : ie;
          }
          function x(L) {
            ...
            (c.convert = function (L, Z) {
              ...
              switch (Z) {
                ...
                case M:
                  ...
                  break;
                case D:
                  if (he) return L + this.unit;
                  if (V && Z.test(L)) return L;
                ...
                case N:
                  ...
                  break;
                case W:
                  if (he) return L + this.angle;
                  if (V && Z.test(L)) return L;
                  ie = "number(deg) or string(angle)";
                  break;
                case H:
                  if (he || (V && N.test(L))) return L;
          ...
          (c.init = function () {
            ...
            (c.values = function (x) {
              var T,
                L = {};
              return (
                S.call(this, x, function (Z, ie, he) {
                  (L[Z] = ie),
        ...
        $ = g(function (c) {
          ...
          (c.init = function (V) {
            ...
            (c.play = function () {
              this.active ||
                (this.start || (this.start = K()), (this.active = !0), _(this));
            }),
            (c.stop = function () {
            ...
            (c.format = function (V, ae) {
              ...
              if (!this.unit) {
                var se = ae.replace(A, ""),
                  _e = V.replace(A, "");
                se !== _e && u("tween", ae, V), (this.unit = se);
              }
              (ae = parseFloat(ae)),
                (V = parseFloat(V)),
          ...
          (c.init = function (S) {
            ...
            (c.render = function (S) {
              ...
              for (x = L; x--; )
                (T = this.tweens[x]),
                  T.context &&
                    (T.render(S), (this.current[T.name] = T.value), (Z = !0));
              return Z
      ...
      (t.fallback = function (c) {
        ...
        (t.delay = function (c, _, S) {
          return new ue({ complete: _, duration: c, context: S });
        }),
      ...
      var p = e.style,
        X = e.css,
        Y = { transform: U.transform && U.transform.css },
        G = {
          color: [v, M],
      ...
      var t = {},
        ...
        N =
          ...
          e.forEach =
            function (O, F, B) {
              if (O == null) return O;
              if (m && O.forEach === m) O.forEach(F, B);
              else if (O.length === +O.length) {
                for (var U = 0, ee = O.length; U < ee; U++)
                  if (F.call(B, O[U], U, O) === t) return;
              } else
                for (var ne = e.keys(O), U = 0, ee = ne.length; U < ee; U++)
                  if (F.call(B, O[ne[U]], ne[U], O) === t) return;
              return O;
            });
      (e.map = e.collect =
        function (O, F, B) {
        ...
        (e.find = e.detect =
          function (O, F, B) {
            var U;
            return (
              W(O, function (ee, ne, q) {
                if (F.call(B, ee, ne, q)) return (U = ee), !0;
              }),
              U
            );
          }),
        ...
        e.any =
          function (O, F, B) {
            ...
            return O == null
              ...
              ? O.some(F, B)
              : (N(O, function (ee, ne, q) {
                  if (U || (U = F.call(B, ee, ne, q))) return t;
                }),
                !!U);
          });
      (e.contains = e.include =
        ...
        (e.debounce = function (O, F, B) {
          var U,
            ...
            d = function () {
              ...
              y < F
                ? (U = setTimeout(d, F - y))
                : ((U = null), B || ((K = O.apply(ne, ee)), (ne = ee = null)));
            };
          return function () {
            (ne = this), (ee = arguments), (q = e.now());
            var y = B && !U;
            return (
              U || (U = setTimeout(d, F)),
              y && ((K = O.apply(ne, ee)), (ne = ee = null)),
              K
            );
          };
        }),
        (e.defaults = function (O) {
          ...
          for (var F = 1, B = arguments.length; F < B; F++) {
            var U = arguments[F];
            for (var ee in U) O[ee] === void 0 && (O[ee] = U[ee]);
          }
          return O;
        }),
        (e.keys = function (O) {
  ...
  var qe = f((pF, ya) => {
    ...
    pe.ready = function () {
      (Pr = !0), jn ? Zv() : Ue.each(St, fa), Ue.each(Kn, fa), pe.resize.up();
    };
    function fa(e) {
      Qe(e) && e();
    }
    ...
    ma.define(
      ...
      (_a.exports = function (e) {
        ...
        function h() {
          ...
          E.length && E.remove(), b || o.append(l);
        }
        return t;
      })
    );
  ...
  var La = f((yF, Ca) => {
    ...
    var $n = window.jQuery,
      ...
      Dr = {
        ...
        intro: function (e, t) {
          t.__wf_intro ||
            ((t.__wf_intro = !0), $n(t).triggerHandler($e.types.INTRO));
        },
        outro: function (e, t) {
          t.__wf_intro &&
            ((t.__wf_intro = null), $n(t).triggerHandler($e.types.OUTRO));
        },
      };
    $e.triggers = {};
    $e.types = { INTRO: "w-ix-intro" + Ra, OUTRO: "w-ix-outro" + Ra };
    $e.init = function () {
      for (var e = Nr.length, t = 0; t < e; t++) {
        var r = Nr[t];
        r[0](0, r[1]);
      }
      (Nr = []), $n.extend($e.triggers, Dr);
    };
    $e.async = function () {
      for (var e in Dr) {
        var t = Dr[e];
  ...
  var Fr = f((mF, Da) => {
    ...
    var tE = window.jQuery,
      ...
      rE = {
        ...
        intro: function (e, t) {
          Zn.triggers.intro(e, t), Pa(t, "COMPONENT_ACTIVE");
        },
        outro: function (e, t) {
          Zn.triggers.outro(e, t), Pa(t, "COMPONENT_INACTIVE");
        },
      };
    Mr.triggers = {};
    Mr.types = { INTRO: "w-ix-intro" + Na, OUTRO: "w-ix-outro" + Na };
  ...
  var ai = f((rr) => {
    ...
    var ts = (rr.ActionTypes = { INIT: "@@redux/INIT" });
    function ns(e, t, r) {
      var n;
      if (
      ...
      return (
        h({ type: ts.INIT }),
        (n = { dispatch: h, subscribe: g, getState: m, replaceReducer: E }),
        (n[es.default] = w),
        n
      );
    }
  ...
  var as = f((ci) => {
    ...
    function HE(e) {
      Object.keys(e).forEach(function (t) {
        var r = e[t],
          n = r(void 0, { type: is.ActionTypes.INIT });
        if (typeof n > "u")
          throw new Error(
            'Reducer "' +
              t +
  ...
  var He,
    ...
    vi = ve(() => {
      ...
      (He = {
        ...
        (fy = { X_AXIS: "X_AXIS", Y_AXIS: "Y_AXIS" }),
        (dy = {
          CHILDREN: "CHILDREN",
          SIBLINGS: "SIBLINGS",
  ...
  var Ct = f((ye) => {
    ...
    function Ss(e, t, r, n) {
      ...
      if (n === t.length - 1) o = r;
        ...
        var a =
          Xr(e) && Xr(e[i]) ? e[i] : typeof t[n + 1] == "number" ? [] : {};
        o = Ss(a, t, r, n + 1);
      }
      return Ur(e, i, o);
    }
    ...
    function Ls(e, t, r, n, o, i, a) {
      ...
      return (
        m.length
          ? (s = Me.call.apply(Me, [null, !1, !1, u, r, n, o, i, a].concat(m)))
  ...
  var Ms,
    ...
    qs = ve(() => {
      ...
      (Ms = le(Ct())),
        ...
        (Jm = { preview: {}, playback: {}, stop: {}, clear: {} }),
        ...
        (Fs = (e = Jm, t) => {
          if (t.type in Ds) {
            let r = [Ds[t.type]];
            return (0, Ms.setIn)(e, [r], { ...t.payload });
          }
          return e;
        });
    });
  ...
  var nr = f((s1, Bs) => {
    var p_ = Br();
    function h_(e, t) {
      for (var r = e.length; r--; ) if (p_(e[r][0], t)) return r;
      return -1;
    }
    Bs.exports = h_;
  });
  ...
  var bi = f((j1, lc) => {
    ...
    function AT(e, t, r, n, o, i) {
      ...
      for (i.set(e, t), i.set(t, e); ++g < u; ) {
        var w = e[g],
          b = t[g];
        if (n) var R = a ? n(b, w, g, t, e, i) : n(w, b, g, e, t, i);
        if (R !== void 0) {
          if (R) continue;
          h = !1;
          break;
        ...
        if (E) {
          if (
            !_T(t, function (A, P) {
              if (!IT(E, P) && (w === A || o(w, A, r, n, i))) return E.push(P);
            })
          ) {
            h = !1;
            break;
  ...
  var Ic = f((Z1, _c) => {
    ...
    function zT(e, t, r, n, o, i, a) {
      switch (r) {
        ...
        case VT:
          var s = n & NT;
          if ((u || (u = PT), e.size != t.size && !s)) return !1;
          var l = a.get(e);
          if (l) return l == t;
          (n |= DT), a.set(e, t);
  ...
  var en = f((E2, nl) => {
    ...
    function bA(e) {
      if (!mA(e)) return _A(e);
      var t = [];
      for (var r in Object(e)) TA.call(e, r) && r != "constructor" && t.push(r);
      return t;
    }
    nl.exports = bA;
  });
  ...
  var ll = f((I2, cl) => {
    ...
    function kA(e, t, r, n, o, i) {
      ...
      for (var g = s; g--; ) {
        var h = u[g];
        if (!(a ? h in t : qA.call(t, h))) return !1;
      }
      var E = i.get(e),
        w = i.get(t);
      ...
      for (var R = a; ++g < s; ) {
        ...
        var A = e[h],
          P = t[h];
        if (n) var C = a ? n(P, A, h, t, e, i) : n(A, P, h, e, t, i);
  ...
  var tn = f((S2, Al) => {
    var Li = dl(),
      ...
      r0 = qt(Mi),
      mt = bl;
    ((Li && mt(new Li(new ArrayBuffer(1))) != Tl) ||
      (Pi && mt(new Pi()) != yl) ||
      (Ni && mt(Ni.resolve()) != ml) ||
      (Di && mt(new Di()) != _l) ||
      (Mi && mt(new Mi()) != Il)) &&
    ...
    function c0(e, t, r, n, o, i) {
      ...
      if (!(r & s0)) {
        ...
        if (E || w) {
          var b = E ? e.value() : e,
            R = w ? t.value() : t;
          return i || (i = new Fi()), o(b, R, r, n, i);
        }
      }
      return h ? (i || (i = new Fi()), o0(e, t, r, n, o, i)) : !1;
    }
    Ll.exports = c0;
  });
  var qi = f((x2, Ml) => {
    ...
    function g0(e, t, r, n) {
      ...
      for (; ++o < i; ) {
        ...
        if (a && u[2]) {
          ...
          var g = new f0();
          if (n) var h = n(l, m, s, e, t, g);
          if (!(h === void 0 ? d0(m, l, p0 | h0, n, g) : h)) return !1;
        }
      }
      return !0;
    }
  ...
  var nn = f((M2, Hl) => {
    ...
    function D0(e, t) {
      ...
      return r == "number" ||
        ...
        L0(e)
        ? !0
        : N0.test(e) || !P0.test(e) || (t != null && e in Object(t));
    }
    Hl.exports = D0;
  });
  var jl = f((F2, Kl) => {
    ...
    function Gi(e, t) {
      ...
      return (r.cache = new (Gi.Cache || zl)()), r;
    }
    Gi.Cache = zl;
    Kl.exports = Gi;
  });
  ...
  var af = f((G2, of) => {
    ...
    function nf(e) {
      ...
      if (H0(e)) return B0(e, nf) + "";
      if (z0(e)) return rf ? rf.call(e) : "";
      var t = e + "";
  ...
  var kt = f((W2, lf) => {
    var tw = dr(),
      rw = 1 / 0;
    function nw(e) {
      if (typeof e == "string" || tw(e)) return e;
      var t = e + "";
  ...
  var on = f((B2, ff) => {
    ...
    function aw(e, t) {
      t = iw(t, e);
      for (var r = 0, n = t.length; e != null && r < n; ) e = e[ow(t[r++])];
  ...
  var Uf = f((uq, Vf) => {
    ...
    function ES(e, t, r) {
      ...
      if (!n) return -1;
      var o = r == null ? 0 : gS(r);
      return o < 0 && (o = vS(n + o, 0)), pS(e, hS(t, 3), o);
    }
    Vf.exports = ES;
  });
  var zi = f((cq, Wf) => {
  ...
  var ji = f((lq, $f) => {
    ...
    function OS(e, t, r, n, o) {
      var i,
        ...
        u = 0;
      do
        (a = t + (r - t) / 2), (i = pn(a, n, o) - e), i > 0 ? (r = a) : (t = a);
    ...
    $f.exports = function (t, r, n, o) {
      ...
      if (t !== r || n !== o)
        for (var a = 0; a < hr; ++a) i[a] = pn(a * dn, t, n);
      function u(s) {
        for (var l = 0, m = 1, g = hr - 1; m !== g && i[m] <= s; ++m) l += dn;
        --m;
  ...
  var gr,
    ...
    Yi = ve(() => {
      ...
      (gr = le(ji())),
        (ot = 1.70158),
        (RS = (0, gr.default)(0.25, 0.1, 0.25, 1)),
        (CS = (0, gr.default)(0.42, 0, 1, 1)),
        (LS = (0, gr.default)(0, 0, 0.58, 1)),
        (PS = (0, gr.default)(0.42, 0, 0.58, 1));
    });
  var Jf = {};
  Pe(Jf, {
    applyEasing: () => pO,
  ...
  function td(e, t, r, n, o) {
    let i =
      r === hO ? (0, Xt.getIn)(o, ["config", "target", "objectId"]) : null;
    return (0, Xt.mergeIn)(e, [n], { id: n, ref: t, refId: i, refType: r });
  }
  function $i(e, t, r, n, o) {
    let i = RO(o);
    return (0, Xt.mergeIn)(e, [t, SO, r], n, i);
  }
  function RO(e) {
    let { config: t } = e;
          ...
          switch (t.type) {
            ...
            case AO: {
              let {
                ...
                s = e;
              return (
                (0, Xt.getIn)(s, [r, n]) !== n && (s = td(s, n, a, r, i)),
                $i(s, r, u, o, i)
              );
            }
            case wO: {
    ...
    var XO = (e) => document.querySelector(`[data-w-id="${e}"]`),
      ...
      BO = (e, t) => {
        ...
        if (e) {
          let i = Object.keys(e),
            a = VO(n, i);
          return a.length ? a.reduce((s, l) => ((s[l] = od[l]), s), e) : e;
        }
        return n.reduce((i, a) => ((i[a] = od[a]), i), {});
      },
      HO = (e) => e.value,
      zO = (e, t) => {
  ...
  var to = f((eo) => {
    ...
    function YO(e) {
      let t,
        ...
        u = (typeof sd[i] == "string" ? sd[i].toLowerCase() : null) || i;
      if (u.startsWith("#")) {
        let s = u.substring(1);
    ...
    var $O = to(),
      ...
      nx = (e, t, r) => {
        let n = r.config.target.objectId,
          ...
          { PLUGIN_VARIABLE: i } = t,
          { size: a, red: u, green: s, blue: l, alpha: m } = i,
          g;
        a != null && (g = a + o),
          u != null &&
            l != null &&
  ...
  var ld = f((oo) => {
    ...
    var ux = new Map([
      [no.ActionTypeConsts.PLUGIN_LOTTIE, { ...ox }],
      [no.ActionTypeConsts.PLUGIN_SPLINE, { ...ax }],
      [no.ActionTypeConsts.PLUGIN_VARIABLE, { ...sx }],
    ]);
  });
  var fd = {};
  Pe(fd, {
  ...
  var Rd = f((Rq, xd) => {
    ...
    function Fx(e, t, r) {
      ...
      return (
        r !== void 0 &&
          ((o = Nx(r)), (o = r < 0 ? Dx(n + o, 0) : Mx(o, n - 1))),
        Lx(e, Px(t, 3), o, !0)
      );
    }
    xd.exports = Fx;
  ...
  function Gx(e, t) {
    ...
    for (let o = 0; o < r.length; o++)
      if (!Object.hasOwn(t, r[o]) || !Pd(e[r[o]], t[r[o]])) return !1;
    return !0;
  }
  var vo,
    Nd = ve(() => {
  ...
  function Io({
    ...
    let N = (t?.action?.config?.affectedElements ?? {})[b || A] || {},
      W = !!(N.id || N.selector),
      H,
      j,
      J,
    ...
    if (
      (W
        ? ((H = N.limitAffectedElements), (j = re), (J = u(N)))
        : (j = J = u({ id: b, selector: A, selectorGuids: P })),
      t && M)
    ) {
      let k = r && (J || M === !0) ? [r] : s(re);
      if (J) {
        if (M === eR) return s(J).filter((O) => k.some((F) => h(O, F)));
        if (M === Dd) return s(J).filter((O) => k.some((F) => h(F, O)));
        if (M === Md) return s(J).filter((O) => k.some((F) => E(F, O)));
      }
      return k;
    }
  ...
  function hR(e, t = {}, r = {}, n, o) {
    ...
    switch (n.actionTypeId) {
      ...
      case Bd:
        return { value: (0, at.default)(parseFloat(i(e, vn)), 1) };
      case Bt: {
        let u = i(e, et),
          s = i(e, tt),
          l,
        ...
        return (
          n.config.widthUnit === ht
            ? (l = qd.test(u) ? parseFloat(u) : parseFloat(r.width))
            : (l = (0, at.default)(parseFloat(u), parseFloat(r.width))),
          n.config.heightUnit === ht
            ? (m = qd.test(s) ? parseFloat(s) : parseFloat(r.height))
      ...
      case _n:
        return { value: (0, at.default)(i(e, En), r.display) };
      case rR:
  ...
  function yR({ element: e, actionItem: t, elementApi: r }) {
    if (_t(t.actionTypeId)) return co(t.actionTypeId)(t.config);
    switch (t.actionTypeId) {
      ...
      case Bt: {
        ...
        if (a === ht) {
          let m = n(e, et);
          o(e, et, ""), (s = i(e, "offsetWidth")), o(e, et, m);
        }
        if (u === ht) {
          let m = n(e, tt);
          o(e, tt, ""), (l = i(e, "offsetHeight")), o(e, tt, m);
        }
  ...
  function wR(e, t, r, n, o) {
    let i = AR.map((u) => {
      ...
      { setStyle: a } = o;
    Tt(e, pt, o), a(e, pt, i), xR(n, r) && a(e, ln, Yx);
  }
  function SR(e, t, r, n) {
    let o = (0, yn.default)(t, (a, u, s) => `${a} ${s}(${u}${bR(s, r)})`, ""),
      { setStyle: i } = n;
    Tt(e, yr, n), i(e, yr, o);
  }
  function OR(e, t, r, n) {
  ...
  function DR(e, t, r, n, o, i) {
    ...
    switch (n.actionTypeId) {
      case Bt: {
        ...
        l !== void 0 && (u === ht && (u = "px"), Tt(e, et, i), a(e, et, l + u)),
          m !== void 0 &&
            (s === ht && (s = "px"), Tt(e, tt, i), a(e, tt, m + s));
        break;
      }
      case Tr: {
        SR(e, r, n.config, i);
  ...
  function FR({ store: e, elementApi: t }) {
    ...
    Object.keys(n).forEach((i) => {
      let a = n[i],
        ...
        { actionListId: s } = u,
        l = o[s];
      l && kd({ actionList: l, event: a, elementApi: t });
    }),
      Object.keys(o).forEach((i) => {
        kd({ actionList: o[i], elementApi: t });
      });
  }
  function kd({ actionList: e = {}, event: t, elementApi: r }) {
    ...
    n &&
      n.forEach((i) => {
        Xd({ actionGroup: i, event: t, elementApi: r });
      }),
      o &&
        o.forEach((i) => {
          let { continuousActionGroups: a } = i;
          a.forEach((u) => {
            Xd({ actionGroup: u, event: t, elementApi: r });
          });
        });
  }
  function Xd({ actionGroup: e, event: t, elementApi: r }) {
    ...
    n.forEach((o) => {
      ...
      _t(i)
        ? (u = (s) => fo(i)(s, o))
        : (u = Yd({ effect: kR, actionTypeId: i, elementApi: r })),
  ...
  function qR(e, t, r) {
    ...
    o(e, Gt) && Yd({ effect: jd, actionTypeId: i, elementApi: r })(e);
  }
  function kR(e, t, r) {
    let { setStyle: n } = r;
    jd(e, t, r), n(e, t, ""), t === pt && n(e, ln, "");
  }
  function Qd(e) {
    let t = 0,
      r = 0;
  ...
  function GR({ actionList: e, actionItemId: t, rawData: r }) {
    let { actionItemGroups: n, continuousParameterGroups: o } = e,
      i = [],
      a = (u) => (
        i.push((0, mn.mergeIn)(u, ["config"], { delay: 0, duration: 0 })),
        u.id === t
      );
    return (
  ...
  var at,
    ...
    Zd = ve(() => {
      "use strict";
      (at = le(pd())), (yn = le(Od())), (gn = le(Ld())), (mn = le(Ct()));
      De();
      Nd();
      Qi();
      Gd = le(to());
      ...
      ({
        ...
        (Hd = (e) => e.trim()),
        (_o = Object.freeze({ [Ht]: Vd, [zt]: $x, [Kt]: Zx })),
        (zd = Object.freeze({
          [pt]: Ux,
          [Vd]: Vx,
          [vn]: vn,
      ...
      (qd = /px/),
        (dR = (e, t) =>
          t.reduce(
            (r, n) => (r[n.type] == null && (r[n.type] = IR[n.type]), r),
            e || {}
          )),
        (pR = (e, t) =>
          t.reduce(
            (r, n) => (
              r[n.type] == null &&
                (r[n.type] = TR[n.type] || n.defaultValue || 0),
              r
            ),
            e || {}
          ));
      (gR = (e, t) => (t && (e[t.type] = t.value || 0), e)),
        ...
        (ER = (e, t, r) => {
          if (_t(e)) return so(e)(r, t);
          switch (e) {
            case Tr: {
              let n = (0, gn.default)(r.filters, ({ type: o }) => o === t);
              return n ? n.value : 0;
            }
            case br: {
              let n = (0, gn.default)(
    ...
    rp = ve(() => {
      ...
      (Tn = le(bt())),
        ...
        (cC = (e, t) => {
          ...
          return (0, st.merge)(e, { position: A, current: W });
        }),
        (lC = (e, t) => {
          let {
              active: r,
          ...
          switch (t.type) {
            ...
            case tC: {
              ...
              return (0, st.set)(e, r, {
                ...
                skipToValue: H,
                customEasingFn:
                  Array.isArray(O) && O.length === 4 ? oC(O) : void 0,
              });
            }
            case rC: {
  ...
  var Op = f((Jq, Sp) => {
    ...
    function tL(e) {
      if (e == null) return 0;
      if (QC(e)) return $C(e) ? ZC(e) : e.length;
      var t = YC(e);
  ...
  var Dp = f((nk, Np) => {
    ...
    function fL(e, t, r) {
      var n = e[t];
      (!(lL.call(e, t) && uL(n, r)) || (r === void 0 && !(t in e))) &&
        sL(e, t, r);
    }
    Np.exports = fL;
  });
  ...
  var hh = f((mk, ph) => {
    ...
    function xP(e, t, r) {
      ...
      function E(N) {
        var W = n,
          H = o;
        return (n = o = void 0), (l = N), (a = e.apply(H, W)), a;
      }
      function w(N) {
        return (l = N), (u = setTimeout(A, t)), m ? E(N) : a;
      }
      function b(N) {
        var W = N - s,
          H = N - l,
      ...
      function P(N) {
        return (u = void 0), h && n ? E(N) : ((n = o = void 0), a);
      }
      function C() {
        u !== void 0 && clearTimeout(u), (l = 0), (n = s = o = u = void 0);
      }
      function M() {
      ...
      function D() {
        var N = Ro(),
          W = R(N);
        if (((n = arguments), (o = this), (s = N), W)) {
          if (u === void 0) return w(s);
          if (g) return clearTimeout(u), (u = setTimeout(A, t)), E(s);
        }
  ...
  var Eh,
    ...
    Sn = ve(() => {
      ...
      (Eh = le(bt())),
        ...
        (rN = (e) => ({ type: XP, payload: { actionListId: e } })),
        (nN = () => ({ type: GP })),
        (bn = (e, t) => ({
          type: VP,
          payload: { target: e, listenerParams: t },
        })),
        (iN = (e = 1) => ({ type: UP, payload: { step: e } })),
        (Do = (e, t) => ({ type: WP, payload: { stateKey: e, newState: t } })),
        (An = (e, t) => ({ type: BP, payload: { now: e, parameters: t } })),
        (Yt = (e, t) => ({ type: HP, payload: { key: e, value: t } })),
        (Mo = (e) => ({ type: zP, payload: { ...e } })),
        (wn = (e, t) => ({ type: KP, payload: { instanceId: e, time: t } })),
        (Fo = (e) => ({ type: jP, payload: { instanceId: e } })),
        (qo = (e, t, r, n) => ({
          type: YP,
  ...
  function Vo({ id: e, selector: t }) {
    if (e) {
      ...
      if (e.indexOf(mh) !== -1) {
        let n = e.split(mh),
          o = n[0];
        if (((r = n[1]), o !== document.documentElement.getAttribute(Ih)))
          return null;
      }
  ...
  var Gh = f((Ck, Xh) => {
    ...
    function CN(e, t, r) {
      return (
        ...
        function () {
          for (
            var n = arguments, o = -1, i = kh(n.length - t, 0), a = Array(i);
            ++o < i;
  ...
  var zo = f((Gk, ug) => {
    ...
    function JN(e) {
      for (
        var t = e.name + "", r = sg[t], n = ZN.call(sg, t) ? r.length : 0;
        n--;
  ...
  var vg = f((Bk, gg) => {
    ...
    function Pn(e) {
      if (fD(e) && !lD(e) && !(e instanceof uD)) {
        ...
        if (hD.call(e, "__wrapped__")) return dD(e);
      }
      return new hg(e);
    }
    ...
    function xD(e) {
      return _D(function (t) {
        ...
        for (e && t.reverse(); n--; ) {
          ...
          if (o && !a && Ko(i) == "wrapper") var a = new mg([], !0);
        }
        for (n = a ? n : r; ++n < r; ) {
          i = t[n];
          var u = Ko(i),
          ...
          s[9] == 1
            ...
            : (a = i.length == 1 && _g(i) ? a[u]() : a.thru(i));
        }
        return function () {
          var l = arguments,
            m = l[0];
          if (a && l.length == 1 && TD(m)) return a.plant(m).value();
  ...
  var qg,
    ...
    $g = ve(() => {
      ...
      (Gg = le(bt())),
        ...
        (rt = (0, qg.default)([Sr, tM])),
        (Kg = (e, t) => {
          if (t) {
            let { ixData: r } = e.getState(),
              { events: n } = r,
              o = n[t];
            if (o && !nM[o.eventTypeId]) return o;
          }
          return null;
        }),
        (rM = ({ store: e, event: t }) => {
          ...
          return (
            l &&
              $t({
                ...
                actionListId: (0, kg.default)(l, "action.config.actionListId"),
              }),
            $t({
              store: e,
              eventId: a,
        ...
        ($o = { types: Qo }),
        (nM = { PAGE_START: Bg, PAGE_FINISH: Wg }),
        (wr = (() => {
        ...
        (Nn = (e = !0) => ({
          ...
          handler: Ke(
            e ? rt : Sr,
            Yg((t, r) => (r.isActive ? Or.handler(t, r) : r))
          ),
        })),
        (Dn = (e = !0) => ({
          ...jg,
          handler: Ke(
            e ? rt : Sr,
            Yg((t, r) => (r.isActive ? r : Or.handler(t, r)))
          ),
        })),
        (Mg = {
          ...$o,
        ...
        (Qg = {
          ...
          [BD]: Nn(),
          [HD]: Dn(),
          [JD]: { types: "ecommerce-cart-open", handler: Ke(rt, Fe) },
          [ZD]: { types: "ecommerce-cart-close", handler: Ke(rt, Fe) },
          [DD]: {
            types: "click",
            handler: Ke(
              rt,
            ...
            handler: (
              ...
              switch (a) {
                ...
                default: {
                  ...
                  if (!M && !uM({ left: g, top: h }, D)) break;
                  (C = !0), (A = b ? (g - N) / H : (h - W) / j);
                  break;
                }
              }
              return (
                R && (A > 1 - Fg || A < Fg) && (A = Math.round(A)),
                (a !== Ze.ELEMENT || C || C !== i.elementHovered) &&
                  ((A = l ? 1 - A : A), e.dispatch(Yt(P, A))),
                {
                  elementHovered: C,
                  clientX: g,
                  clientY: h,
          ...
          [$D]: {
            ...
            handler: (
              ...
              if (m === Ze.VIEWPORT) {
                let M = C ? i / u : a / s;
                return (
                  M !== o.scrollPercent && t.dispatch(Yt(h, M)),
                  { scrollPercent: M }
                );
              } else {
                let M = Cg(n, h),
                ...
                return (
                  O !== o.scrollPercent && t.dispatch(Yt(M, O)),
                  { scrollPercent: O }
                );
              }
            },
  ...
  function CM(e) {
    At({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: NM }),
      At({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: DM }),
      At({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: MM }),
      At({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: FM });
  }
  function LM(e) {
    At({
      store: e,
  ...
  function NM({ rawData: e, defer: t }, r) {
    let n = () => {
      Gn({ store: r, rawData: e, allowEvents: !0 }), uv();
    };
    t ? setTimeout(n, 0) : n();
  }
  function uv() {
  ...
  function DM(e, t) {
    ...
    if (n && o && m && u) {
      ...
      g && (m = mM({ actionList: g, actionItemId: o, rawData: m }));
    }
    if (
      (Gn({ store: t, rawData: m, allowEvents: a, testManual: s }),
      (n && r === Ne.GENERAL_START_ACTION) || Jo(r))
    ) {
      $t({ store: t, actionListId: n }),
        lv({ store: t, actionListId: n, eventId: i });
      let g = xr({
        store: t,
        eventId: i,
        actionListId: n,
      ...
      l && g && t.dispatch(Qt({ actionListId: n, isPlaying: !u }));
    }
  }
  function MM({ actionListId: e }, t) {
    e ? $t({ store: t, actionListId: e }) : fv({ store: t }), Vn(t);
  }
  function FM(e, t) {
    Vn(t), sv({ store: t, elementApi: Re });
  }
  function Gn({ store: e, rawData: t, allowEvents: r, testManual: n }) {
    ...
    t && e.dispatch(Co(t)),
      o.active ||
        ...
        r &&
          (UM(e), qM(), e.getState().ixSession.hasDefinedMediaQueries && LM(e)),
        e.dispatch(Po()),
        kM(e, n));
  }
  function qM() {
  ...
  function kM(e, t) {
    let r = (n) => {
      ...
      o.active &&
        (e.dispatch(An(n, i)), t ? PM(e, r) : requestAnimationFrame(r));
    };
  ...
  function GM({
    ...
    A.forEach((M) => {
      ...
      R.forEach(({ element: M, key: D }) => {
        let N = b[D],
          W = (0, ut.default)(N, "[0].actionItems[0]", {}),
          { actionTypeId: H } = W,
          j = Xn(H) ? ra(H)(M, W) : null,
          J = ta({ element: M, actionItem: W, elementApi: Re }, j);
        na({
          store: e,
          element: M,
          eventId: n,
  ...
  function jM({ logic: e, store: t, events: r }) {
    ...
    (0, Zt.default)(u, (g, h) => {
      ...
      wM(R, i.mediaQueryKeys) || t.dispatch(Xo()),
        ...
        (w.actionTypeId === Ne.GENERAL_START_ACTION || Jo(w.actionTypeId)) &&
          lv({ store: t, actionListId: A, eventId: b });
    });
    let s = (g) => {
        ...
        zM(u, (E, w, b) => {
          ...
          if (!kn(C, h.mediaQueryKey)) return;
          let M = (D = {}) => {
            let N = o(
              {
                store: t,
          ...
          P.actionTypeId === Ne.GENERAL_CONTINUOUS_ACTION
      ...
      m = ({ target: g = document, types: h, throttle: E }) => {
        h.split(" ")
          ...
          .forEach((w) => {
            let b = E ? l : s;
            g.addEventListener(w, b), t.dispatch(bn(g, [w, b]));
          });
      };
  ...
  function YM(e) {
    ...
    for (let n in e) {
      let { eventTypeId: o, target: i } = e[n],
        a = Vo(i);
      t[a] ||
        ((o === He.MOUSE_CLICK || o === He.MOUSE_SECOND_CLICK) &&
          ((t[a] = !0),
  ...
  function lv({ store: e, actionListId: t, eventId: r }) {
    ...
    if (s && s.useFirstGroupAsInitialState) {
      ...
      if (!kn(m, o.mediaQueryKey)) return;
      l.forEach((g) => {
        let { config: h, actionTypeId: E } = g,
          w =
            h?.target?.useEventTarget === !0 && h?.target?.objectId == null
              ...
              : h,
          b = qn({ config: w, event: u, elementApi: Re }),
          R = Xn(E);
        b.forEach((A) => {
          let P = R ? ra(E)(A, g) : null;
          na({
            destination: ta({ element: A, actionItem: g, elementApi: Re }, P),
            immediate: !0,
            store: e,
            element: A,
            eventId: r,
  ...
  function fv({ store: e }) {
    ...
    (0, Zt.default)(t, (r) => {
      if (!r.continuous) {
        ...
        ia(r, e), o && e.dispatch(Qt({ actionListId: n, isPlaying: !1 }));
      }
    });
  }
  function $t({
    ...
    (0, Zt.default)(i, (s) => {
      ...
      if (s.actionListId === o && s.eventId === t && m) {
        if (u && l && !Uo(u, s.element)) return;
        ia(s, e),
          s.verbose && e.dispatch(Qt({ actionListId: o, isPlaying: !1 }));
      }
    });
  }
  function xr({
    ...
    let { ixData: s, ixSession: l } = e.getState(),
      ...
      E = (0, ut.default)(s, `actionLists.${o}`, {}),
      { actionItemGroups: w, useFirstGroupAsInitialState: b } = E;
    if (!w || !w.length) return !1;
    i >= w.length && (0, ut.default)(g, "config.loop") && (i = 0),
      i === 0 && b && i++;
    let A =
        (i === 0 || (i === 1 && b)) && Jo(g.action?.actionTypeId)
          ? g.config.delay
          : void 0,
      P = (0, ut.default)(w, [i, "actionItems"], []);
    if (!P.length || !kn(h, l.mediaQueryKey)) return !1;
    ...
    return (
      P.forEach((N, W) => {
        ...
        qn({
          ...
          D = !0;
          let ne = M === W && B === 0,
            q = EM({ element: F, actionItem: N }),
            K = ta({ element: F, actionItem: N, elementApi: Re }, U);
          na({
            store: e,
            element: F,
            actionItem: N,
  ...
  function na(e) {
    let { store: t, computedStyle: r, ...n } = e,
      ...
      { refState: A } = E[R] || {},
      P = Wo(o),
      C = w.reducedMotion && Ei[i.actionTypeId],
      M;
    if (C && s)
    ...
    At({ store: t, select: ({ ixInstances: N }) => N[h], onChange: pv }),
  ...
  function ia(e, t) {
    ...
    let { elementId: r, actionItem: n } = e,
      ...
      { ref: i, refType: a } = o[r] || {};
    a === av && TM(i, n, Re), t.dispatch(Fo(e.id));
  }
  function dv(e, t, r) {
    ...
    if (kn(W, M.mediaQueryKey) && (n || r || o)) {
      ...
      if (o) {
        if (b) {
          ...
          A && !H && t.dispatch(Qt({ actionListId: w, isPlaying: !1 }));
        }
        ia(e, t);
      }
    }
    ...
    Zo = ve(() => {
      ...
      (HM = (e, t) => (0, rv.default)((0, iv.default)(e, t), nv.default)),
        ...
        (KM = (e) => {
          ...
          return qn({ config: t, elementApi: Re });
        });
    });
  var Ev = f((aa) => {
    "use strict";
    ...
    var Un = (0, ZM.createStore)(JM.default);
    function nF(e) {
      e() && (0, oa.observeRequests)(Un);
    }
    function iF(e) {
      vv(), (0, oa.startEngine)({ store: Un, rawData: e, allowEvents: !0 });
    }
    function vv() {
      (0, oa.stopEngine)(Un);
    }
      ...
      (Tv.exports = function (e, t) {
        ...
        function E() {
          (o = i && Jt.env("design")),
            ...
            Jt.scroll.off(b),
            (g = []);
          for (var A = document.links, P = 0; P < A.length; ++P) w(A[P]);
          g.length && (Jt.scroll.on(b), b());
        }
        function w(A) {
          if (!A.getAttribute("hreflang")) {
            ...
            if (((u.href = P), !(P.indexOf(":") >= 0))) {
              ...
              if (
                ...
                var M = e(u.hash);
                M.length && g.push({ link: C, sec: M, active: !1 });
                return;
              }
              if (!(P === "#" || P === "")) {
                var D =
                  u.href === a.href || P === h || (l.test(P) && m.test(h));
                R(C, s, D);
              }
            }
          }
        ...
        function C(k, O) {
          ...
          switch (O) {
            case "add":
              (F = k.attr("tabindex")),
                F
                  ? k.attr("data-wf-tabindex-swap", F)
                  : k.attr("tabindex", "-1");
              break;
            case "remove":
            ...
            if (a) {
              ...
              (m = P),
                Math.abs(C) > s &&
                  r &&
                  String(r()) === "" &&
                  (o("swipe", R, { direction: C > 0 ? "right" : "left" }), w());
            }
          }
          function E(R) {
    ...
    Bn.define(
      ...
      (Rv.exports = function (e, t) {
        ...
        function M() {
          ...
          n.on(
            ...
            n.on("change", u + ' form input[type="radio"]', (Q) => {
              e(`input[name="${Q.target.name}"]:not(${q})`).map((ue, me) =>
                e(me).siblings(K).removeClass(d)
              );
              let $ = e(Q.target);
        ...
        function N(q) {
          var K = q.btn,
            d = q.wait;
          K.prop("disabled", !0), d && ((q.label = K.val()), K.val(d));
        }
        function W(q, K) {
          var d = null;
          return (
            ...
            q
              ...
              .each(function (y, I) {
                var v = e(I),
                  z = v.attr("type"),
                  Q =
                    v.attr("data-name") || v.attr("name") || "Field " + (y + 1);
                Q = encodeURIComponent(Q);
                var $ = v.val();
                if (z === "checkbox") $ = v.is(":checked");
                else if (z === "radio") {
        ...
        function H(q) {
          var K = {};
          return (
            q.find(':input[type="file"]').each(function (d, y) {
              var I = e(y),
                v = I.attr("data-name") || I.attr("name") || "File " + (d + 1),
                z = I.attr("data-value");
              typeof z == "string" && (z = e.trim(z)), (K[v] = z);
            }),
            K
          );
        }
        ...
        function U(q, K) {
          if (!K.fileUploads || !K.fileUploads[q]) return;
          var d,
            y = e(K.fileUploads[q]),
            I = y.find("> .w-file-upload-default"),
            v = y.find("> .w-file-upload-uploading"),
            z = y.find("> .w-file-upload-success"),
            Q = y.find("> .w-file-upload-error"),
            $ = I.find(".w-file-upload-input"),
            ue = I.find(".w-file-upload-label"),
            me = ue.children(),
            oe = Q.find(".w-file-upload-error-msg"),
            p = z.find(".w-file-upload-file"),
            X = z.find(".w-file-remove-link"),
            Y = p.find(".w-file-upload-file-name"),
            G = oe.attr("data-w-size-error"),
          ...
          function _(T, L) {
            ...
            var Z = L.fileName,
              ...
              he = L.fileId,
              V = L.s3Url;
            $.attr("data-value", he), ne(V, ie, d, Z, S);
          }
          function S(T) {
            if (T) return c(T);
            v.toggle(!1),
        ...
        function ee(q, K) {
          var d = new URLSearchParams({ name: q.name, size: q.size });
    ...
    gt.define(
      ...
      (Lv.exports = function (e, t) {
        ...
        function B(p) {
          return function (X) {
            switch (X.keyCode) {
              case Ae.SPACE:
              case Ae.ENTER:
                return q(p)(), X.preventDefault(), X.stopPropagation();
              case Ae.ESCAPE:
                return oe(p), X.preventDefault(), X.stopPropagation();
              case Ae.ARROW_RIGHT:
              case Ae.ARROW_DOWN:
              case Ae.HOME:
              case Ae.END:
        ...
        function I(p, X) {
          ...
          if ((Y.open && !G && !l && oe(Y, !0), Y.container.length)) {
            var fe = z(Y);
        ...
        function z(p) {
          ...
          return (
            X === "none" && (X = ""),
            function (Y, G) {
              (G = e(G)), G.css(v, ""), G.css(v) === "none" && G.css(v, X);
            }
          );
        }
        function Q(p, X) {
        ...
        function ue(p, X) {
          ...
          if (
            (p.overlay &&
              ((M = p.menu.prev()), p.overlay.show().append(p.menu)),
            Y.animOver)
          ) {
            n(p.menu)
              .add(S)
          ...
          var x = c + Ce;
          n(p.menu).add(S).set({ y: -x }).start({ y: 0 }).then(T);
          function T() {
        ...
        function oe(p, X) {
          ...
          if (Y.animOver) {
            n(p.menu)
              .add(G)
              .start({ x: Ce * Y.animDirect })
              .then(_);
            return;
          }
          var c = Xe + fe;
          n(p.menu).add(G).start({ y: -c }).then(_);
          function _() {
            p.menu.height(""),
              ...
              p.overlay &&
                ...
                (M.length ? p.menu.insertAfter(M) : p.menu.prependTo(p.parent),
    ...
    vt.define(
      ...
      (Dv.exports = function (e, t) {
        ...
        (r.ready = function () {
          ...
          (r.destroy = R);
        function b() {
          (i = o.find(s)), i.length && (i.each(C), !E && (R(), A()));
        }
        function R() {
          vt.resize.off(P), vt.redraw.off(r.redraw);
        }
        function A() {
          vt.resize.on(P), vt.redraw.on(r.redraw);
        }
        function P() {
        ...
        function C(d, y) {
          ...
          if (
            (z || ((z = "w-slider-mask-" + d), v.mask.attr("id", z)),
          ...
          v.el.off(s),
            ...
            M(v),
            a
              ? (v.el.on("setting" + s, O(v)), k(v), (v.hasTimer = !1))
              : (v.el.on("swipe" + s, O(v)),
                ...
                v.config.autoplay &&
                  !v.hasTimer &&
                  ((v.hasTimer = !0), (v.timerCount = 1), re(v)),
          ...
          $.addClass(g), w || U(d, y), Q.removeClass(g), $.removeClass(g);
        }
        function M(d) {
          var y = {};
          (y.crossOver = 0),
        ...
        function O(d) {
          return function (y, I) {
            ...
            if (a && y.type === "setting") {
              ...
              if (I.select === "next") return j(d)();
              if ((M(d), ee(d), I.select == null)) return;
              J(d, I.select);
              return;
            }
            if (y.type === "swipe")
              return v.disableSwipe || vt.env("editor")
                ? void 0
                : I.direction === "left"
                ? j(d)()
                : I.direction === "right"
            ...
            if (d.nav.has(y.target).length) {
              ...
              if (
                (y.type === "click" && B(d, { index: z }), y.type === "keydown")
              )
                switch (y.keyCode) {
                  case nt.ENTER:
                  case nt.SPACE: {
                    B(d, { index: z }), y.preventDefault();
                    break;
                  }
                  case nt.ARROW_LEFT:
                  case nt.ARROW_UP: {
                    F(d.nav, Math.max(z - 1, 0)), y.preventDefault();
                    break;
                  }
                  case nt.ARROW_RIGHT:
                  case nt.ARROW_DOWN: {
                    F(d.nav, Math.min(z + 1, d.pages)), y.preventDefault();
                    break;
                  }
                  case nt.HOME: {
        ...
        function B(d, y) {
          ...
          if (
            ...
            a || (p.each(h.intro), Y.each(h.outro)),
            y.immediate && !w)
          ) {
            n(p).set(oe), T();
            return;
          ...
          if (
            (a || d.ariaLiveLabel.text(`Slide ${z + 1} of ${v.length}.`),
            G === "cross")
          ) {
            var S = Math.round(Ce - Ce * I.crossOver),
              x = Math.round(Ce - S);
            (c = "opacity " + S + "ms " + fe),
              n(X).set({ visibility: "" }).add(c).start({ opacity: 0 }),
              n(p)
                .set({ visibility: "", x: me, opacity: 0, zIndex: d.depth++ })
                .add(c)
                .wait(x)
                .then({ opacity: 1 })
                .then(T);
          ...
          I.infinite && Q.x
            ? (n(d.slides.not(X))
                ...
                .add(_)
                .start({ x: me }),
              n(X).set({ visibility: "", x: Q.from }).add(_).start({ x: Q.to }),
              (d.shifted = X))
            : (I.infinite &&
                d.shifted &&
                (n(d.shifted).set({ visibility: "", x: ue }),
                (d.shifted = null)),
              n(d.slides).set({ visibility: "" }).add(_).start({ x: me }));
          function T() {
            (p = e(v[d.index].els)),
              (Y = d.slides.not(p)),
        ...
        function ee(d) {
          ...
          var ue = d.index;
          ue >= y && (ue = y - 1), B(d, { immediate: !0, index: ue });
        }
        function ne(d) {
          var y = [],
            I,
          ...
          for (var z = 0, Q = d.pages; z < Q; z++)
            (I = e(l)),
              I.attr("aria-label", "Show slide " + (z + 1) + " of " + Q)
                .attr("aria-pressed", "false")
                .attr("role", "button")
                .attr("tabindex", "-1"),
...
Webflow.require("ix2").init({
  events: {
    ...
    "e-21": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66c9834106b0d169d18af934|02770828-ba72-7742-44da-70869cb41b23",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
